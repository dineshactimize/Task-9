...
const Footer = () => {
  return (
    <div>
      <Box sx={{p:0,m:0}}>
        <Box sx={{ bgcolor: '#313035', color: 'white', textAlign: 'center', p: 2, mt: 4 }}>
        ...
        <Box sx={{display:'flex',justifyContent:'space-evenly',bgcolor:'grey',p:2, flexWrap:'wrap', gap:2}}>
        <Box sx={{ bgcolor: 'grey', color: 'white', textAlign: 'center', p: 1, height: { xs: 72, md: 82 }, width: { xs: 72, md: 100 } }}>
        ...
        <Box sx={{ bgcolor: '#313035', color: 'white', textAlign: 'center', p: 2 }}>
          <Typography >
            MOVIES NOW SHOWING IN HYDERABAD
            Andhra King Taluka | Raju Weds Rambai | Tere Ishk Mein|12A Railway Colony |Premante
          </Typography>
        </Box>
          
     <Box sx={{bgcolor:"#333338"}}>
      <Box sx={{display:'flex',justifyContent:'center',p:2}}>
        <img src="https://res.cloudinary.com/doaaeqnk2/image/upload/v1763723952/pngegg_qtrb5z.png" alt="" style={{height:33.9,maxWidth:115,width:'100%'}} />
      </Box>
      <Box sx={{display:'flex',justifyContent:'center',flexWrap:'wrap',gap:1,pb:2}}>
      ...
      <Box>
        <Container>
         <Box sx={{display:'grid',justifyContent:'center'}}>
          <Typography align='center' variant='p'sx={{color:'#666666'}}>
