  ...
  return (
    <div>
      ...
      <Box sx={{p:0,m:0}}>
        ...
        <Box sx={{display:'flex',justifyContent:'space-evenly',bgcolor:'grey',height:112}}>
        <Box sx={{ bgcolor: 'grey', color: 'white', textAlign: 'center', p: 1, height: 82, width: 100 }}>
     ...
     <Box sx={{bgcolor:"#333338"}}>
      <Box sx={{display:'flex',justifyContent:'center',p:2}}>
        <img src="https://res.cloudinary.com/doaaeqnk2/image/upload/v1763723952/pngegg_qtrb5z.png" alt="" style={{height:33.9,width:115}} />
      </Box>
      <Box sx={{display:'flex',justifyContent:'center'}}>
       
       <Box sx={{height:35.87,width:35.87}}>
